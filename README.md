...
This project is implememted using two STM32 boards (e.g., Blue Pill or similar) and E220-900T22D LoRA modules, this project demonstrates bidirectional text transmission over long range (up to several hundred meters) via UART communication. 
